(function(w){
  ...
  TW.svgIcon=function(name){var p={grid:'班',book:'备',calendar:'表',check:'核',clipboard:'记',chart:'析',ear:'听',users:'研',flag:'班',heart:'健',shield:'安',file:'表',gear:'设',home:'工',list:'作',dorm:'宿',seat:'座',mental:'心',selection:'选',grade:'年',notice:'知',duty:'值',awards:'评',hygiene:'卫',broom:'扫',points:'分',alert:'警'};return p[name]||'模'};
